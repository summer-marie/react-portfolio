...
- [ ] `index.html`'s new `<link rel="canonical">` uses a placeholder domain (`https://summerhalsey.dev`) — the real production domain wasn't confirmed (see `.agent-memory/OPEN_QUESTIONS.md`).