...
These wireframes define the approved page layouts for Version 1.

They describe layout, spacing, hierarchy, and content organization only.
...
Agents should treat these wireframes as layout references, not pixel-perfect mockups.